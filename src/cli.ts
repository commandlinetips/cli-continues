...
program
  .name('continues')
  .description('Never lose context. Resume any AI coding session across Claude, Copilot, Gemini, Codex & OpenCode.')
  .version(VERSION)
...
program
  ...
  .option('-s, --source <source>', 'Filter by source (claude, copilot, gemini, codex, opencode)')
...
program
  ...
  .option('-i, --in <cli-tool>', 'Target CLI tool (claude, copilot, gemini, codex, opencode)')
